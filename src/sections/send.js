  ...
  return (
    <div id="section-4">
      ...
      <div className="o-highlight o-highlight--success">
        {/* <h3 className="o-highlight__color u-marginBottom-0_5x"><T _str="That&apos;s it! You&apos;re done with all setup & coding!" /></h3> */}
        <h3 className="o-highlight__color u-marginBottom-0_5x">That&apos;s it! You&apos;re done with all setup & coding!</h3>

        {/* <p className="u-color-muted"><T _str="Now for the fun part of actual translations &amp; preview of your localized application!" /></p> */}
